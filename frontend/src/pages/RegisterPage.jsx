...
import { Wallet, Lock, Mail, User, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
export const RegisterPage = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'radial-gradient(circle at top left, rgba(16,185,129,0.15), transparent 50%), var(--bg-primary)', padding: '1rem' }}>
      <div className="glass-card" style={{ width: '100%', maxWidth: '440px', padding: '2.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'inline-flex', background: 'linear-gradient(135deg, #10b981, #6366f1)', padding: '0.75rem', borderRadius: '14px', marginBottom: '1rem' }}>
            <Wallet size={32} color="#fff" />
          </div>
          <h2>Create Account</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '0.5rem' }}>
            Get started with FinAssist AI RAG
          </p>
        </div>
